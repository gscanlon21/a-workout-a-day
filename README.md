...
[Download the app](https://github.com/gscanlon21/a-workout-a-day/releases). The program [Obtanium](https://github.com/ImranR98/Obtainium) can be used to setup automatic updates.
