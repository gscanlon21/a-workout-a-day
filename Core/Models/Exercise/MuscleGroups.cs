...
public static class MuscleGroupExtensions
{
    ...
    public static IList<MuscleGroups> All()
    {
        ...
        [
            ...
            MuscleGroups.PelvicFloor, MuscleGroups.Nose, MuscleGroups.VocalCords, MuscleGroups.Eyes, MuscleGroups.Neck, MuscleGroups.Diaphragm, MuscleGroups.Throat, MuscleGroups.Mind, MuscleGroups.Face,
