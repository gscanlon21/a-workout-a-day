...
--
-- Name: newsletter_exercise_variation; Type: TABLE; Schema: public; Owner: gzpkkndowr
--

CREATE TABLE public.newsletter_exercise_variation (
    "Id" integer NOT NULL,
...
ALTER TABLE public.newsletter_exercise_variation OWNER TO gzpkkndowr;

--
-- Name: TABLE newsletter_exercise_variation; Type: COMMENT; Schema: public; Owner: gzpkkndowr
--

COMMENT ON TABLE public.newsletter_exercise_variation IS 'A day''s workout routine';


--
-- Name: newsletter_exercise_variation_Id_seq; Type: SEQUENCE; Schema: public; Owner: gzpkkndowr
--

ALTER TABLE public.newsletter_exercise_variation ALTER COLUMN "Id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public."newsletter_exercise_variation_Id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: user_frequency; Type: TABLE; Schema: public; Owner: gzpkkndowr
--
...
ALTER TABLE public.user_frequency OWNER TO gzpkkndowr;

--
-- Name: user_muscle; Type: TABLE; Schema: public; Owner: gzpkkndowr
--
...
ALTER TABLE public.user_muscle OWNER TO gzpkkndowr;
...
900	Scapular Pulldowns	6	\N	lat-pulldowns-alt.jpg	0	131104	f	8	8	f	65542	\N	\N	lat-pulldown.webp	t	f	12582912	1
...
SELECT pg_catalog.setval('public."EquipmentGroup_Id_seq"', 1744, true);
...
SELECT pg_catalog.setval('public."Exercise_Id_seq"', 323, true);
...
SELECT pg_catalog.setval('public."Footnote_Id_seq"', 195, true);
...
SELECT pg_catalog.setval('public."IntensityPreference_Id_seq"', 4373, true);
...
SELECT pg_catalog.setval('public."Intensity_Id_seq"', 901, true);
...
SELECT pg_catalog.setval('public."Newsletter_Id_seq"', 26386, true);
...
SELECT pg_catalog.setval('public."User_Id_seq"', 293, true);
...
SELECT pg_catalog.setval('public."exercise_variation_Id_seq"', 976, true);
...
--
-- Name: newsletter_exercise_variation PK_newsletter_exercise_variation; Type: CONSTRAINT; Schema: public; Owner: gzpkkndowr
--

ALTER TABLE ONLY public.newsletter_exercise_variation
    ADD CONSTRAINT "PK_newsletter_exercise_variation" PRIMARY KEY ("Id");
...
--
-- Name: user_frequency PK_user_frequency; Type: CONSTRAINT; Schema: public; Owner: gzpkkndowr
--
...
--
-- Name: user_muscle PK_user_muscle; Type: CONSTRAINT; Schema: public; Owner: gzpkkndowr
--
...
--
-- Name: IX_newsletter_exercise_variation_ExerciseVariationId; Type: INDEX; Schema: public; Owner: gzpkkndowr
--

CREATE INDEX "IX_newsletter_exercise_variation_ExerciseVariationId" ON public.newsletter_exercise_variation USING btree ("ExerciseVariationId");


--
-- Name: IX_newsletter_exercise_variation_NewsletterId; Type: INDEX; Schema: public; Owner: gzpkkndowr
--

CREATE INDEX "IX_newsletter_exercise_variation_NewsletterId" ON public.newsletter_exercise_variation USING btree ("NewsletterId");
...
--
-- Name: newsletter_exercise_variation FK_newsletter_exercise_variation_exercise_variation_ExerciseVa~; Type: FK CONSTRAINT; Schema: public; Owner: gzpkkndowr
--

ALTER TABLE ONLY public.newsletter_exercise_variation
    ADD CONSTRAINT "FK_newsletter_exercise_variation_exercise_variation_ExerciseVa~" FOREIGN KEY ("ExerciseVariationId") REFERENCES public.exercise_variation("Id") ON DELETE CASCADE;


--
-- Name: newsletter_exercise_variation FK_newsletter_exercise_variation_newsletter_NewsletterId; Type: FK CONSTRAINT; Schema: public; Owner: gzpkkndowr
--

ALTER TABLE ONLY public.newsletter_exercise_variation
    ADD CONSTRAINT "FK_newsletter_exercise_variation_newsletter_NewsletterId" FOREIGN KEY ("NewsletterId") REFERENCES public.newsletter("Id") ON DELETE CASCADE;
...
--
-- Name: user_frequency FK_user_frequency_user_UserId; Type: FK CONSTRAINT; Schema: public; Owner: gzpkkndowr
--
...
--
-- Name: user_muscle FK_user_muscle_user_UserId; Type: FK CONSTRAINT; Schema: public; Owner: gzpkkndowr
--
