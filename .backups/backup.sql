...
SELECT pg_catalog.setval('public."exercise_Id_seq"', 987, true);
...
SELECT pg_catalog.setval('public."instruction_Id_seq"', 3176, true);
...
SELECT pg_catalog.setval('public."variation_Id_seq"', 1868, true);
