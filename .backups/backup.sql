...
SELECT pg_catalog.setval('public."User_Id_seq"', 813, true);
...
SELECT pg_catalog.setval('public."instruction_Id_seq"', 3357, true);
...
SELECT pg_catalog.setval('public."variation_Id_seq"', 1940, true);
