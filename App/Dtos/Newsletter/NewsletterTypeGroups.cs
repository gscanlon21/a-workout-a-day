...
public class NewsletterTypeGroups : IEnumerable<NewsletterRotation>, IEnumerator<NewsletterRotation>
{
    ...
    /// Creates an instance that starts at the next newsletter rotation.
    /// </summary>
    public NewsletterTypeGroups(User user, Frequency frequency, NewsletterRotation? previousRotation)
    {
        Frequency = frequency;
    ...
    /// </summary>
    private static IEnumerable<NewsletterRotation> GetOffDayStretchingRotation(User? user = null)
    {
