...
{
    public ExerciseViewModel(Dtos.User.User? user, Dtos.Exercise.Exercise exercise, Variation variation, ExerciseVariation exerciseVariation,
    ...
    */
    ...
    public Dtos.Exercise.Exercise Exercise { get; private init; } = null!;
