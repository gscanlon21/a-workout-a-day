...
namespace FinerFettle.Web.Migrations
{
    ...
    [Migration("20221007145515_ExerciseRequisite")]
    partial class ExerciseRequisite
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinerFettle.Web.Models.Exercise.ExerciseRequisite", b =>
                {
                    b.Property<int>("ExerciseId")
                        .HasColumnType("integer");

                    b.Property<int>("RequiresProficiencyOfId")
                        .HasColumnType("integer");

                    b.HasKey("ExerciseId", "RequiresProficiencyOfId");

                    b.HasIndex("RequiresProficiencyOfId");

                    b.ToTable("exercise_requisite");
            ...
            modelBuilder.Entity("FinerFettle.Web.Models.Exercise.ExerciseRequisite", b =>
                {
                    ...
                    b.HasOne("FinerFettle.Web.Models.Exercise.Exercise", "RequiresProficiencyOf")
                        .WithMany("Requisites")
                        .HasForeignKey("RequiresProficiencyOfId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Exercise");

                    b.Navigation("RequiresProficiencyOf");
                });
