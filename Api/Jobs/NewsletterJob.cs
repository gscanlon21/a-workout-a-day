...
public class NewsletterJob : IJob, IScheduled
{
    ...
    public NewsletterJob(MailSender mailSender, HttpClient httpClient, IOptions<SiteSettings> siteSettings, NewsletterController newsletterController, UserController userController, CoreContext coreContext)
    {
    ...
    public async Task Execute(IJobExecutionContext context)
    {
        try
        {
            var currentHour = Int32.Parse(DateTime.UtcNow.ToString("HH"));
    ...
    public static async Task Schedule(IScheduler scheduler)
    {
        ...
        // Trigger the job to run every 25 minutes
