...
public partial class NewsletterRepo
{
    ...
    private async Task<IList<QueryResults>> GetDebugExercises(User user)
    {
        ...
        {
            if (exerciseVariation.Variation.Stretches == MusculoskeletalSystem.None
                && exerciseVariation.Variation.Section.HasFlag(Section.CooldownStretching)
                && exerciseVariation.Variation.ExerciseFocus.HasFlag(ExerciseFocus.Flexibility)) 
            {
