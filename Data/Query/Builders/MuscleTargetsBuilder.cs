...
/// </summary>
public class MuscleTargetsBuilder : IOptions, IMuscleGroupBuilderNoContext, IMuscleGroupBuilderTargets, IMuscleGroupBuilderFinal
{
    ...
    {
        MuscleTargets = UserMuscleStrength.MuscleTargets(Context!.User).Keys
