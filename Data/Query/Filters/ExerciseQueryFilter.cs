...
public class ExerciseQueryFilter : BaseQueryFilter
{
    ...
    {
        return queryResults.Select(r => new QueryResults(section, r.Exercise, r.Variation, r.UserExercise, r.UserVariation, r.Prerequisites, r.Postrequisites, r.EasierVariation, r.HarderVariation, UserOptions.Intensity)).ToList();
    }
}
